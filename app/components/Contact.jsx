...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-6 mt-10 mb-8">
          <motion.input
        ...
        <motion.button
          ...
          type="submit"
          className="py-3 px-8 w-max flex items-center justify-between gap-2 border-1 bg-[#11001f] text-white/80 rounded-full mx-auto hover:bg-black duration-500"
        >
          Submit now{" "}
